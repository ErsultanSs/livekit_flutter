...
class _RoomPageState extends State<RoomPage> {
  ...
  final TextEditingController _messageController = TextEditingController(); // Text controller for input
              ...
              child: Padding(
                ...
                child: Row(
                  children: [
                    Expanded(
                      child: TextField(
                        controller: _messageController, // Use text controller
                    ...
                    IconButton(
                      ...
                      onPressed: () {
                        _sendMessage(_messageController.text); // Send message
                      },
                    ),
                  ],
                ),
